                ...
                <div style={{ marginBottom: '2rem' }}>
                    <div style={{ width: '100%', height: '100%' }}>
                        <div style={{ marginTop: '1rem', marginLeft: '2rem', marginRight: '2rem' }}>
                            ...
                            <Button style={{ marginTop: '1rem', marginLeft: '2rem', marginRight: '2rem', background: '#CFDFFF', color: '#111' }}>{post.fields.TransformX_Success_Story_Industry}</Button><br />
                            <Button style={{ marginTop: '1rem', marginLeft: '2rem', marginRight: '2rem', background: '#CFDFFF', color: '#111' }}>{post.fields.TransformX_Success_Story_Sub_Region}</Button>
                            <br />
                            ...
                            <Button style={{ marginTop: '1rem', background: '#CFDFFF', color: '#111' }}>{post.fields.TransformX_Success_Story_Challenge_Title}</Button><br/>
                            ...
                            <Button style={{ marginTop: '1rem', background: '#CFDFFF', color: '#111' }}>{post.fields.Vendor_API_Name_1}</Button><br/>
