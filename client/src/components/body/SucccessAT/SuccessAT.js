                ...
                <div style={{ marginBottom: '2rem' }}>
                    <div style={{ width: '100%', height: '100%' }}>
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', margin: '2rem 0', marginLeft: '2rem', marginRight: '2rem',background:'#1283DA'}}>{/*
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <p style={{ color: '#ced4da', fontSize: '16px', marginBottom: '-0.3rem' }}>{post.fields.Vendor_Name}/{post.fields.Success_Client_Name} - Success</p>
                                <h2 style={{ fontSize: '30px', fontWeight: '500', color: '#383838' }}>{post.fields.Success_Name}</h2>
                    ...
                    <div style={{ width: '100%', height: '100%' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', marginTop: '-2rem', marginLeft: '2rem', marginRight: '2rem' }}>
                            <div className="card" style={{ padding: '0rem', paddingTop: '0.5rem', margin: '0 2rem',minWidth: '1000px', maxWidth: '800px', textAlign: 'justify', marginLeft: '11rem', }}>
                                <br />
                                <p style={{ textAlign: 'justify', fontSize: 'clamp(1.4rem, 1.2vw, 1rem)', color: '#383838' }}><b>Challenge</b><br /></p>
