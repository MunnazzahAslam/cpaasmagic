...
export default () => (
    <div>
        <div style={{ color: '#1B2653' }}>
            <p style={{margin:'1rem', marginLeft:'3.2rem', fontWeight:'bold'}}>Discover Successes</p>
            <iframe class="airtable-embed" src="https://airtable.com/embed/shrG38QWFYoFyXWOG?backgroundColor=blue&viewControls=on" width="100%" height="800" style={{ background: 'transparent', border: 'none' }}></iframe>
        </div>
