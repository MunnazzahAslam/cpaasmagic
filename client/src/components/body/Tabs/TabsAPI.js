...
export default () => (
    <div>
        <div style={{ color: '#444444' }}>
            <p style={{margin:'1rem', marginLeft:'3.2rem', fontWeight:'bold'}}>Discover APIs</p>
            <iframe class="airtable-embed" src="https://airtable.com/embed/shrjRGsrTVofgqLNO?backgroundColor=blue&viewControls=on" width="100%" height="800" style={{ background: 'transparent', border: 'none' }}></iframe>
        </div>
