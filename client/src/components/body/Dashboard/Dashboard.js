...
function Dashboard() {
    return (
        <div style={{ color: '#1B2653', marginBottom: '-2rem' }}>
            <iframe class="airtable-embed" src="https://airtable.com/embed/shrG809ltLoLwuy9i?backgroundColor=blue" frameborder="0" onmousewheel="" width="100%" height="900" style={{ background: 'transparent', border: 'none', marginBottom: '-4rem' }}></iframe>
