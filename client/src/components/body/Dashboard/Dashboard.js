...
function Dashboard() {
    return (
        <div style={{ color: '#1B2653' }}>
           <iframe class="airtable-embed" src="https://airtable.com/embed/shrHkYaVbBXJZ3Di5?backgroundColor=purple" frameborder="0" onmousewheel="" width="100%" height="1200px" style={{background: 'transparent', border: '1px solid #ccc'}}></iframe> 
